                ...
                <div class="login-form">
                    <form>
                        ...
                        <div class="form-input-join">
                            <input id="userId" type="text" name="" value="" placeholder="아이디를 입력해주세요." style="width: 17.04rem;">
                        ...
                        <div class="form-input-join">
                            <input id="userPw" type="password" name="" value="" placeholder="비밀번호를 입력해주세요." style="width: 23.3rem;" maxlength="12">
                        </div>
                        ...
                        <div class="form-input-join" style="display: flex;">
                            <input id="email" type="text" name="" value="" placeholder="이메일을 입력해주세요." style="width: 15.2rem;">
                        ...
                        <div class="form-input-join">
                            <input id="username" type="text" name="" value="" placeholder="이름을 입력해주세요." style="width: 23.3rem;">
                        </div>

                        <label for="tell">전화번호</label>
                        <div class="form-input-join" style="align-items: center;">
                            <input id="tel1" type="text" name="" value="" maxlength="3"> <a>-</a>
                            <input id="tel2" type="text" name="" value="" maxlength="4"> <a>-</a>
                            <input id="tel3" type="text" name="" value="" maxlength="4">
                        </div>
                        
                        <label for="address">주소</label>
                        <div class="form-input-join">
                            <input id="address" type="text" name="" value="" placeholder="주소를 입력해주세요." style="width: 23.3rem;">
                        </div>

                        <label for="birthday">생년월일</label>
                        <div class="form-input-join">
                            <input id="birthday" type="date" name="" value="" style="width: 23.3rem;">
                        </div>
